...
- **Silver Blue** (`#717490`): Secondary text, muted elements (WCAG AA 4.56:1 on white)
- **Silver Blue Soft** (`#9497a9`): Decorative / non-text only (borders, separators, placeholders)
...
- Secondary text: `#717490`  (WCAG AA compliant)
